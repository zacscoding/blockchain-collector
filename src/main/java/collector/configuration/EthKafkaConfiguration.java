...
public class EthKafkaConfiguration {

    private KafkaProperties kafkaProperties;
    private EthKafkaProperties ethKafkaProperties;

    @Autowired
    public EthKafkaConfiguration(KafkaProperties kafkaProperties, EthKafkaProperties ethKafkaProperties) {
