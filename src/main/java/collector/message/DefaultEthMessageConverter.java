...
public class DefaultEthMessageConverter implements EthMessageConverter {

    @Override
    public String convertBlockEvent(EthBlockEvent blockEvent) {
    ...
    @Override
    public String convertTxEvent(EthTxEvent txEvent) {
    ...
    @Override
    public String convertPendingTxEvent(EthPendingTxEvent pendingTxEvent) {
